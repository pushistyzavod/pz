...
(function () {
  ...
  var css = ''
    ...
    + '.site-topbar .wrap{max-width:1240px;margin:0 auto;padding:9px 28px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px}'
    ...
    + '.site-header .wrap{max-width:1240px;margin:0 auto;padding:0 44px;display:grid;grid-template-columns:auto 1fr auto;align-items:center;column-gap:32px;height:78px}'

    + '.site-logo{font-weight:700;font-size:21px;letter-spacing:-.2px;display:inline-flex;align-items:center;gap:11px;color:var(--sink);text-decoration:none;white-space:nowrap}'
    ...
    // menu (centered)
    + '.site-menu{display:flex;align-items:center;justify-content:center;gap:6px;font-weight:500;font-size:15px}'
    + '.site-menu>a,.site-mega-trigger{position:relative;color:#3a3d46;text-decoration:none;padding:10px 14px;border-radius:10px;transition:color .15s,background .15s;white-space:nowrap}'
    + '.site-menu>a:hover,.site-mega-trigger:hover{color:var(--sink);background:#f3f5fa}'
    + '.site-menu>a::after{content:"";position:absolute;left:14px;right:14px;bottom:5px;height:2px;border-radius:2px;background:var(--spink);transform:scaleX(0);transform-origin:left;transition:transform .2s}'
    ...
    // right cta
    + '.site-cta{display:flex;gap:16px;align-items:center;justify-self:end}'
    + '.site-contact{display:flex;flex-direction:column;align-items:flex-end;gap:5px;line-height:1.1}'
    + '.site-phone{font-weight:700;font-size:17px;white-space:nowrap;color:var(--sink);text-decoration:none}'
    ...
    + '.site-btn{display:inline-flex;align-items:center;justify-content:center;padding:13px 24px;border-radius:30px;font-weight:600;font-size:14.5px;background:var(--spink);color:#fff;text-decoration:none;border:none;cursor:pointer;transition:.2s;box-shadow:0 10px 22px -12px rgba(255,96,153,.8)}'
    ...
    + '  .site-header .wrap{grid-template-columns:auto auto;height:70px}'
    ...
    + '  .site-cta{justify-self:end}.site-contact{display:none}'
